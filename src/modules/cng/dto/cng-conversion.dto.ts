...
/** Partial update for inspection images / file URLs stored as TEXT (e.g. JSON array string). */
export class UpdateUserCngConversionInspectionDto {

  @ApiProperty({ description: 'Conversion ID', example: '123e4567-e89b-12d3-a456-426614174000' })
  @IsUUID()
  conversionId: string;

  @ApiPropertyOptional({
    description:
      'Exterior inspection image URLs (JSON array string or delimiter-separated)',
  ...
  @ApiPropertyOptional({
    description:
      'Interior inspection image URLs (JSON array string or delimiter-separated)',
  ...
  @ApiPropertyOptional({
    description:
      'Engine inspection image URLs (JSON array string or delimiter-separated)',
  ...
  @ApiPropertyOptional({
    description:
      'Key areas inspection image URLs (JSON array string or delimiter-separated)',
  ...
  // @ApiPropertyOptional({ description: 'Mark online inspection step completed' })
  // @IsOptional()
  // @IsBoolean()
  // hasCompletedOnlineInspection?: boolean;

  // @ApiPropertyOptional({ description: 'Mark registration step completed' })
  // @IsOptional()
  // @IsBoolean()
