...
//   //     if (user.referalCode) {
//   //       this.logger.log(
//   //         `User ${event.userId} already has referral code: ${user.referalCode}`,
//   //       );
//   //       return;
//   //     }
...
//   //       const existingUser =
//   //         await this.userRepository.findByReferalCode(referalCode);
//   //       if (!existingUser) {
//   //         isUnique = true;
//   //       } else {
//   //         attempts++;
//   //         this.logger.warn(
//   //           `Referral code ${referalCode} already exists, generating new one...`,
//   //         );
//   //       }
//   //     }
...
//   //     this.logger.log(
//   //       `Successfully generated referral code ${referalCode} for user ${event.userId}`,
//   //     );
//   //     return;
//   //   } catch (error) {
//   //     this.logger.error(
//   //       `Failed to process referral code for user ${event.userId}:`,
//   //       error,
//   //     );
//   //   }
//   // }

//   // private async handleReferralTracking(
//   //   referredUserId: string,
//   //   usedReferalCode: string,
//   // ) {
//   //   try {
//   //     this.logger.log(
//   //       `Processing referral tracking for user ${referredUserId} with code ${usedReferalCode}`,
//   //     );
...
//   //       this.logger.warn(
//   //         `User ${referredUserId} attempted to use their own referral code. Skipping.`,
//   //       );
//   //       return;
//   //     }
...
//   //     if (!referrerUser) {
//   //       this.logger.warn(
//   //         `Referral code ${usedReferalCode} not found or belongs to the same user. Skipping referral tracking.`,
//   //       );
//   //       return;
//   //     }
...
//   //     if (!referrerUser.id) {
//   //       this.logger.error(
//   //         `Referrer user ${referrerUser.id} has invalid ID. Skipping referral tracking.`,
//   //       );
//   //       return;
//   //     }
...
//   //       await this.referalUserService.findByReferredUserId(referredUserId);
//   //     if (existingReferral) {
//   //       this.logger.log(
//   //         `User ${referredUserId} was already referred. Skipping duplicate record.`,
//   //       );
//   //       return;
//   //     }
