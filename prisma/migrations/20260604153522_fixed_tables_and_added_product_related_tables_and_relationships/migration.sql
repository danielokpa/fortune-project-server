...
-- CreateEnum
CREATE TYPE "InventoryUnit" AS ENUM ('PIECE', 'BUNCH', 'BAG', 'CARTON', 'CRATE', 'PACK', 'KG', 'GRAM', 'LITRE');

-- CreateEnum
CREATE TYPE "ProductStatus" AS ENUM ('DRAFT', 'IN_STOCK', 'OUT_OF_STOCK', 'ARCHIVED');
...
CREATE TABLE "products" (
    ...
    "maximumOrderQuantity" DECIMAL(12,2),
...
CREATE TABLE "orders" (
    ...
    "recipientPhoneNo" TEXT NOT NULL,
    "recipientEmail" TEXT,
...
-- CreateIndex
CREATE INDEX "products_originStateId_idx" ON "products"("originStateId");
...
-- AddForeignKey
ALTER TABLE "products" ADD CONSTRAINT "products_originStateId_fkey" FOREIGN KEY ("originStateId") REFERENCES "states"("id") ON DELETE SET NULL ON UPDATE CASCADE;
