...
exports.SAFETY_QUESTIONS = void 0;
const client_1 = require("@prisma/client");
exports.SAFETY_QUESTIONS = [
    {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.EASY,
        weight: 3,
        question: 'You receive a personal phone call while driving. What should you do?',
        options: [
            {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.EASY,
        weight: 3,
        question: 'A passenger offers extra money if you exceed the speed limit. What should you do?',
        options: [
    ...
    },
    {
        ...
        weight: 5,
        question: 'While driving, a passenger asks you to check a message on their phone. What should you do?',
        options: [
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.MEDIUM,
        weight: 5,
        question: 'You notice a warning light appear on the dashboard during a trip. What should you do?',
        options: [
            {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.MEDIUM,
        weight: 5,
        question: 'Weather conditions suddenly worsen during a trip. What should you do?',
        options: [
    ...
    },
    {
        ...
        weight: 8,
        question: 'You are running behind schedule and risk receiving a poor rating. What should you do?',
        options: [
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.HARD,
        weight: 8,
        question: 'A passenger insists you make an illegal U-turn to save time. What should you do?',
        options: [
            {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.HARD,
        weight: 8,
        question: 'You suspect another driver on the road is impaired. What is the safest action?',
        options: [
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.HARD,
        weight: 8,
        question: 'An EV battery is draining unusually quickly during a trip. What should you prioritize?',
        options: [
            {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.HARD,
        weight: 8,
        question: 'A minor collision occurs with no visible injuries. What should you do first?',
        options: [
            {
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.MEDIUM,
        weight: 5,
        question: 'If visibility becomes severely reduced during a trip, the best response is:',
        options: [
    ...
    },
    {
        ...
        difficulty: client_1.QuestionDifficulty.HARD,
        weight: 8,
        question: 'A passenger pressures you to break multiple safety rules because they are late. What should guide your decision?',
        options: [
...
//# sourceMappingURL=safety.constant.js.map