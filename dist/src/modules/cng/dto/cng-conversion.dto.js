...
exports.UpdateUserCngConversionInspectionDto = exports.CreateCngConversionDto = void 0;
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'CNG conversion center id (UUID, FK to cng_conversion_stations)',
...
class UpdateUserCngConversionInspectionDto {
    conversionId;
...
exports.UpdateUserCngConversionInspectionDto = UpdateUserCngConversionInspectionDto;
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Conversion ID', example: '123e4567-e89b-12d3-a456-426614174000' }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], UpdateUserCngConversionInspectionDto.prototype, "conversionId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Exterior inspection image URLs (JSON array string or delimiter-separated)',
        example: '["https://cdn.example.com/exterior/1.jpg"]',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(50000),
    __metadata("design:type", String)
], UpdateUserCngConversionInspectionDto.prototype, "exteriorInspectionImages", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Interior inspection image URLs (JSON array string or delimiter-separated)',
        example: '["https://cdn.example.com/interior/1.jpg"]',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(50000),
    __metadata("design:type", String)
], UpdateUserCngConversionInspectionDto.prototype, "interiorInspectionImages", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Engine inspection image URLs (JSON array string or delimiter-separated)',
        example: '["https://cdn.example.com/engine/1.jpg"]',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(50000),
    __metadata("design:type", String)
], UpdateUserCngConversionInspectionDto.prototype, "engineImages", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({
        description: 'Key areas inspection image URLs (JSON array string or delimiter-separated)',
        example: '["https://cdn.example.com/key/1.jpg"]',
    }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MaxLength)(50000),
    __metadata("design:type", String)
], UpdateUserCngConversionInspectionDto.prototype, "keyAreasImages", void 0);
